...
for arg in sys.argv[1:]:
    ...
    # Default setting
    print(arg)
    DXL_ID                      = int(arg)                 # Dynamixel ID : 1
    BAUDRATE                    = 1000000             # Dynamixel default baudrate : 57600
    DEVICENAME                  = '/dev/ttyUSB0'    # Check which port is being used on your controller
                                                    # ex) Windows: "COM1"   Linux: "/dev/ttyUSB0" Mac: "/dev/tty.usbserial-*"

    FACTORYRST_DEFAULTBAUDRATE  = 1000000             # Dynamixel baudrate set by factoryreset
    NEW_BAUDNUM                 = 1000000                 # New baudnum to recover Dynamixel baudrate as it was
    OPERATION_MODE              = 0x02              # Mode is unavailable in Protocol 1.0 Reset
